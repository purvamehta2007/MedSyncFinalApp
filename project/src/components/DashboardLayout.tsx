...
import { Pill, Chrome as Home, Package, Bell, ClipboardList, Heart, Users, TriangleAlert as AlertTriangle, LogOut, Menu, X, Brain, Activity } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Health Readings', href: '/dashboard/health-readings', icon: Activity },
